        ...
        <div className="space-y-16">
            ...
            <section className="text-center">
                ...
                <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
                    Créez, organisez et suivez vos parcours d'apprentissage
                    personnalisés. Transformez vos objectifs en étapes concrètes
                    et mesurables.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="card p-8 text-center">
                        ...
                        <p className="text-gray-600">
                            Organisez vos ressources d'apprentissage en parcours
                            logiques et progressifs.
                        </p>
                    </div>
                    ...
                    <div className="card p-8 text-center">
                        ...
                        <p className="text-gray-600">
                            Définissez des objectifs précis et mesurez vos
                    ...
                    <div className="card p-8 text-center">
                        ...
                        <p className="text-gray-600">
                            Partagez vos parcours et découvrez ceux créés par
                            d'autres apprenants.
                        </p>
                    </div>
                </div>
            ...
            <section className="bg-primary-600 rounded-2xl p-12 text-center text-white">
                ...
                <p className="text-xl mb-8 opacity-90">
                    Rejoignez des milliers d'apprenants qui transforment leurs
