...
import { Brain, Target, Sparkles, TrendingUp, BookOpen, Award } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto leading-relaxed">
            FlashLearn AI crée des parcours d'apprentissage personnalisés basés sur vos objectifs. Des flashcards
            intelligentes aux quiz adaptatifs, maîtrisez n'importe quel sujet efficacement.
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="border-2 hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Créez des objectifs d'apprentissage personnalisés avec un niveau cible et une date limite
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Passez une évaluation de 25 questions générée par l'IA pour déterminer votre niveau actuel
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>
                Recevez des parcours d'apprentissage personnalisés avec des modules progressifs et des flashcards
              </CardDescription>
            </CardHeader>
          </Card>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex items-center justify-center">
                  <div className="relative">
                    ...
                    <Brain className="h-48 w-48 text-primary relative" />
                  </div>
                </div>
              </div>
            </CardContent>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto text-center space-y-8 bg-primary text-primary-foreground rounded-2xl p-12">
          <h2 className="text-4xl font-bold text-balance">Prêt à transformer votre apprentissage ?</h2>
          <p className="text-lg text-pretty opacity-90">
            Rejoignez des milliers d'apprenants qui utilisent l'IA pour atteindre leurs objectifs plus rapidement.
          </p>
          <Link href="/register">
      ...
      <footer className="border-t bg-muted/30 mt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">© 2025 FlashLearn AI. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
